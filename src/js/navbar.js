...
export function navbar() {
    ...
    <a href="./index.html" class="logo-link">
        <svg aria-label="Instagram" class="nav_logo" fill="#262626" height="24" viewBox="0 0 48 48" width="24">
            <path
    ...
    <div>
        ...
        <svg aria-label="Activity Feed" class="navbar-icon" fill="#262626" height="24" viewBox="0 0 48 48"
            width="24">
            <path clip-rule="evenodd"
        ...
        <a class="marginR" href="./register.html">
            <svg aria-label="새로운 게시물" class="_ab6-" color="#262626" fill="#262626" height="24" role="img"
        ...
        <a href="./profile.html">
            <svg aria-label="Profile" class="" fill="#262626" height="24" viewBox="0 0 48 48" width="24">
                <path
